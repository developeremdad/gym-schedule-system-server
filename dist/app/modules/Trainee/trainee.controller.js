...
const createNewTrainee = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield trainee_service_1.TraineeServices.createNewTraineeIntoDB(req.body);
...
const getAllTrainees = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield trainee_service_1.TraineeServices.getAllTraineesFromDB(req.query);
    (0, sendResponse_1.default)(res, {
