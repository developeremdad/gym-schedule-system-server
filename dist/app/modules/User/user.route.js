...
router.get('/get-users', (0, auth_1.default)(user_constant_1.USER_ROLE.admin, user_constant_1.USER_ROLE.trainee), user_controller_1.UserControllers.getAllUsers);
router.get('/me', (0, auth_1.default)(user_constant_1.USER_ROLE.admin, user_constant_1.USER_ROLE.trainer, user_constant_1.USER_ROLE.trainee), user_controller_1.UserControllers.getMe);
